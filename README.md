...
## 📌 사용자 관리
- Admin 관리자가 사용자 계정을 생성 한다.
- 사용자 계정 생성시 사번, 이메일, 비밀번호  
- 각각의 사용자는 하나이상의 권한 그룹에 소속된다. 
- 각각의 사용자는 권한그룹을 통해 접근할 수 있는 팀 저장소가 결정된다. 
- 권한이 있는 팀 저장소내에서 문서내에 각 문단에 수정사항을 요청할 수 있다.
- 각 사용자는 팀 저장소내에 있는 다른 팀원들의 수정사항들을 열람하고 수정사항들에 댓글을 달 수 있다.
